                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="form-group row">
                                            ...
                                            >Mild with Co-morbidity</label>
                                            <label
                                                class="col-sm-3 col-form-label text-center"
                                            >Severe with Co-morbidity</label>
                                            <label
                                                class="col-sm-3 col-form-label text-center"
                                            >Mild w/o Co-morbidity</label>
                                            <label
                                                class="col-sm-3 col-form-label text-center"
                                            >Sever w/o Co-morbidity</label>
                                        </div>
                                    </div>
                                </div>
                                <!-- PUI in BRGY -->
        ...
        checkIfBarangayEncoded(date) {
            axios
                ...
                .then(response => {
                    if (response.data > 0) {
                        this.$snotify.error(
                            "You already added data to this date",
                            "Error"
                        );
                    }
                });
